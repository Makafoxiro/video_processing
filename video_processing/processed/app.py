...
def make_progress(parent, style_name):
    ...
    # Python 3.14: ttk no longer inherits layouts automatically for custom style
    # names, so we must explicitly copy the layout from the base style.
    s.layout(style_name, s.layout("Horizontal.TProgressbar"))
    var = tk.DoubleVar()
